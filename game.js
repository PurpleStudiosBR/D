...
function iaAreaMode(self, timeArr, adversArr, bola, side) {
  ...
  // Defesa: posiciona entre bola e o próprio gol
  if (inDefArea(self)) {
  ...
  // Ataque: tenta alinhar com o gol adversário enquanto vai até a bola
